...
imap.select('Inbox')
_, x = imap.search(None,'FROM', 'noreply@mail.overclock.net')
...
def getMsgID(x):
    ...
    for num in x[0].split():
        ...
        print(datito)
        a += 1
        with open('MsgIDsOC.txt', 'a') as f: #se crea el archivo de texto con el data set
...
def getSecondLastReceived(x):
    ...
    for num in x[0].split():
        ...
        a += 1
        with open('SecondLastReceivedOC.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
...
def getFirstReceived(x):
    ...
    for num in x[0].split():
        ...
        a += 1
        with open('FirstReceivedOC.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
...
def getUTC(x):
    ...
    for num in x[0].split():
        ...
        d33 = str(d3[-15:])
        a += 1
        with open('UTCsOC.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
                print (d33)
# get from
def getFrom(x):
    ...
    for num in x[0].split():
        ...
        print(datito4)
        a += 1
        with open('MailsTOC.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
                print(datito4)           
