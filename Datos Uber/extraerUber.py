...
imap.select('Inbox')
_, x = imap.search(None,'FROM', 'uber.chile@uber.com')
...
def getMsgID(x):
    ...
    for num in x[0].split():
        ...
        print(datito)
        a += 1
        with open('MsgIDsUber.txt', 'a') as f: #se crea el archivo de texto con el data set
...
def getSecondLastReceived(x):
    ...
    for num in x[0].split():
        ...
        a += 1
        with open('SecondLastReceivedUber.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
...
def getFirstReceived(x):
    ...
    for num in x[0].split():
        ...
        a += 1
        with open('FirstReceivedUber.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
...
def getUTC(x):
    ...
    for num in x[0].split():
        ...
        d33 = str(d3[-15:])
        a += 1
        with open('UTCsUber.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
                print (d33)
# get from
def getFrom(x):
    ...
    for num in x[0].split():
        ...
        print(datito4)
        a += 1
        with open('MailsUber.txt', 'a') as f: #se crea el archivo de texto con el data set
            with redirect_stdout(f):
                print(datito4)           
